    ...
    const TERMS_MPT = [
      {line:"T7 2WD",rows:[["до 14.03","субс. бренда"],["с 14.03 до 15.04","МПТ"],["с 16.04 до 7.05","субс. бренда"],["с 8.05 и далее","МПТ"]]},
    ...
    function kmBankRate(bankId, group, months, downPct){
      ...
      let idx=0, best=Math.abs(terms[0]-n);
      ...
      return {rate: Number(rate)||0, term: terms[idx], band};
    }
    const KM_MODELS = [
